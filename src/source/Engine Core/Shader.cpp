#include "../../headers/Engine Core/Shader.h"
...
void Shader::compileShader(std::string fileName, uint32_t& shaderID, const char* shader, GLenum shaderType) const {
...
void Shader::attachShader(std::vector<std::string> files, std::vector<uint32_t> shaderIDs) {
