...
void HDR::calcSMAAbuffers(uint32_t screenTexture) {
...
void HDR::renderToDefaultBuffer(float exposure, uint32_t bloomBuffer, bool enableBloom) {
...
void HDR::renderToDefaultBufferMSAA(float exposure, uint32_t bloomBuffer, bool enableBloom)
{
