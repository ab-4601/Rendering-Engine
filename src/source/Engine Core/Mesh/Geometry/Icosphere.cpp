#include "../../../../headers/Engine Core/Mesh/Geometry/Icosphere.h"

Icosphere::Icosphere(GLenum windingOrder, int subdivisions)
    : Mesh(windingOrder) {
    tempIndices.clear();
    _generateIcosahedron();
    _smoothSphere(subdivisions);
}
...
void Icosphere::_smoothSphere(int subdivisions) {
