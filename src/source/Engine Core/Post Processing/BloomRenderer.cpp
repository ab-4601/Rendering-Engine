...
void BloomRenderer::renderBloomTexture(uint32_t srcTexture, float filterRadius, uint32_t currFramebuffer) {
	mFBO.enableWriting();
...
void BloomRenderer::renderBloomTextureMSAA(float filterRadius, uint32_t currFramebuffer) {
