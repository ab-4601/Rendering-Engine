#include "../../../headers/Engine Core/Post Processing/SSAO.h"
...
void SSAO::genTexture(uint32_t& texID, GLenum colorAttachment, GLint internalFormat, GLenum format,
...
void SSAO::calcSSAO(uint32_t gPosition, uint32_t gNormal, uint32_t currFramebuffer) {
	glBindFramebuffer(GL_FRAMEBUFFER, FBO);
