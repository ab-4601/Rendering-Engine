#include "../../../headers/Engine Core/Shadows/PointShadows.h"

PointShadow::PointShadow(float nearPlane, float farPlane)
...
void PointShadow::calculateShadowTransforms(glm::vec3 lightPosition) {
...
void PointShadow::calculateShadowMap(std::vector<Mesh*>& meshes, int windowWidth, int windowHeight,
	glm::vec3 lightPosition, uint32_t currentFramebuffer)
{
